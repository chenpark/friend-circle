...
#import "CYCWaterFlowLayout.h"
#import "CYCPhotoViewCell.h"
#import "CYCPhoto.h"
#import <Photos/Photos.h>
static NSString * const reuseIdentifier = @"Cell";

@interface CYCPhotoViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,CYCWaterFlowLayoutDelegate>
/** 容器视图 */
@property(nonatomic, strong) UICollectionView *collectionView;

@property (strong, nonatomic) NSArray *dataArray;
/** 被选中的图片对应的模型对象 */
@property (strong, nonatomic) NSMutableArray<CYCPhoto *> *selectedPhotos;
@end

@implementation CYCPhotoViewController
...
- (void)setupCollectionView {
    ...
    [self.collectionView registerClass:[CYCPhotoViewCell class] forCellWithReuseIdentifier:reuseIdentifier];
}
...
#pragma mark -
#pragma mark - =============== 懒加载 ===============
- (NSMutableArray<CYCPhoto *> *)selectedPhotos {
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        CYCWaterFlowLayout * layout = [[CYCWaterFlowLayout alloc]init];
        layout.delegate = self;
        _collectionView =  [[UICollectionView alloc] initWithFrame:self.view.bounds collectionViewLayout:layout];
        _collectionView.backgroundColor = [UIColor yellowColor];
        [_collectionView registerClass:[CYCPhotoViewCell class] forCellWithReuseIdentifier:reuseIdentifier];
...
- (NSArray *)enumerateAssetsInAssetCollection:(PHAssetCollection *)assetCollection original:(BOOL)original {
    ...
    for (PHAsset *asset in assets) {
        ...
        [[PHImageManager defaultManager] requestImageForAsset:asset targetSize:size contentMode:PHImageContentModeDefault options:options resultHandler:^(UIImage * _Nullable result, NSDictionary * _Nullable info) {
            CYCPhoto * photo = [[CYCPhoto alloc]init];
            photo.image = result;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CYCPhotoViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    CYCPhotoViewCell * cell = (CYCPhotoViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
    CYCPhoto * photo = self.dataArray[indexPath.row];
...
#pragma mark -
#pragma mark - =============== CYCWaterFlowLayoutDelegate ===============
